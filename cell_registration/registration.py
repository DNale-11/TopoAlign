...
def estimate_rigid_transform_from_matches(
    ...
    """
    Estimate a rigid transform using matched cell centroids.
    ...
    use_scale : bool, optional
        If True, estimate a similarity transform; otherwise use a rigid transform.
    ...
    transform = estimate_transform(method, B, A)
